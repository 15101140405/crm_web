...
<head>
    ...
    <title><?php echo Yii::app()->params['appName']; ?></title>
    <?php
    ...
    Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . "/../library/plugins/sco/js/sco.collapse.js", CClientScript::POS_END);
    ?>
        ...
        'items' => array(
            array(
                ...
                'items' => array(
                    array(
                        'label' => '日志',
                        'url' => Yii::app()->createUrl("log/admin"),
                        'active' => ($this->id == 'log') ? true : false,
                        'visible' => true,
                    ),
                ),
            ),
