  ...
  <div class="ulist_module pad_b50">
        ...
        ?>
            <li class="ulist_item flex">
                餐标折扣价
                <div class="flex1">
                    <input class="align_r t_green" type="text" placeholder="<?php  echo $arr_feast_order['discount_bill'];?>" id="price"/>
                </div>
            ...
            <li class="ulist_item flex">
                桌数
                <div class="flex1">
                    <input class="align_r t_green" type="text" placeholder="<?php  echo $arr_feast_order['table_num'];?>" id="number"/>
                </div>
            ...
            <li class="ulist_item flex">
                服务费
                <div class="flex1">
                    <input class="align_r t_green" type="text" placeholder="<?php  echo $arr_feast_order['service_charge_ratio'];?>" id="fee"/>
                </div>
            </li>
            <!-- <li class="ulist_item">备注</li> 
            <li class="remark">
                <div class="text_bar">
                    <textarea maxlength="70" placeholder="<?php  echo $arr_feast_order['remark'];?>" id="remark"></textarea>
                </div>
            </li> -->
        </ul>
    </div>
        ...
        if ( $("#price").val() == "" ) {
           ...
           /* var f_info = get_feast_info();
            $.postJSON('#',f_info,function(retval){
                if(retval.success){*/
                    location.href = "wed&meeting_feast.html";
/*                }else{
