...
$(function  () {
    ...
    $(".order_list li").on("click",function(){
        if ("<?php echo $_GET['tab'];?>" == "set") {
            ...
            location.href = "<?php echo $this->createUrl('design/tpDetail');?>&product_id=<?php if (isset($_GET['product_id'])){echo $_GET['product_id'];}?>&type=new&tab=<?php echo $_GET['tab'];?>&from=<?php echo $_GET['from'];?>&order_id=" + $(this).attr("order-id");
        };
    ...
    $(".add_btn").on("click",function(){
        location.href = "<?php echo $this->createUrl("product/createorder", array());?>&set_id=<?php if (isset($_GET['set_id'])){echo $_GET['set_id'];}?>&product_id=<?php if (isset($_GET['product_id'])){echo $_GET['product_id'];}?>&from=<?php echo $_GET['from']?>&category=<?php echo $_GET['category']?>";
    });
})
</script>
</body>
