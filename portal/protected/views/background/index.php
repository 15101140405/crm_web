    ...
    <div class="wapper index_container">
        ...
        <div class="nav_box">
            <ul class="nav_list clearfix">
                <li><a class="active" href="javascript:;">HOME</a>
                </li>
                <li><a href="javascript:;">UPLOAD</a>
                </li>
                <li><a href="javascript:;">TRENDS</a>
                </li>
                    ...
                    <div class="left clearfix">
                        <div class="select_box left">
                            ...
                            <select class="select_list" name="" id="">
                                ...
                                <option value="上传时间(由新到旧)">上传时间(由新到旧)</option>
                                <option value="上传时间(由新到旧新到新到新到)">上传时间(由新到旧)</option>
                                <option value="上传时间(由新到旧)">上传时间(由新到旧)</option>
                            </select>
                        </div>
                        <div class="select_box left">
                        ...
                        <p class="left">共<span class="num">1</span>个视频</p>
                    </div>
                    <button class="right upload_new_btn">上传新视频</button>
                </div>
