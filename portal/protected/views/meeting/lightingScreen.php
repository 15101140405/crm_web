            ...
            switch (type_id) {
                ...
                ?>
                    ...
                    $("#product li.selected").on("click", function () {
                        location.href = "<?php echo $this->createUrl("meeting/tpDetail", array());?>&product_id=" + $(this).attr("lighting-id") + "&type=edit&tab=lighting&from=" + $.util.param("from") + "&order_id=" + $.util.param("order_id");
                    })
                    $("#product li.list_more").on("click", function () {
                        location.href = "<?php echo $this->createUrl("meeting/tpDetail", array());?>&product_id=" + $(this).attr("lighting-id") + "&type=new&tab=lighting&from=" + $.util.param("from") + "&order_id=" + $.util.param("order_id");
                    })
                    break;
...
/*                $arr_category_screen = array(//background data
                ...
                ?>
                    ...
                    $("li.selected").on("click", function () {
                        location.href = "<?php echo $this->createUrl("meeting/tpDetail", array());?>&product_id=" + $(this).attr("screen-id") + "&type=edit&tab=screen&from=" + $.util.param("from") + "&order_id=" + $.util.param("order_id");
                    })
                    $("li.list_more").on("click", function () {
                        location.href = "<?php echo $this->createUrl("meeting/tpDetail", array());?>&product_id=" + $(this).attr("screen-id") + "&type=new&tab=screen&from=" + $.util.param("from") + "&order_id=" + $.util.param("order_id");
                    })
                    break;
            }
        }
