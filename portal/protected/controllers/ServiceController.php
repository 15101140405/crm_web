...
//                'actions' => array(''),
    ...
    {
        $type=$_GET['type_id'];
        $sql = yii::app()->db->createCommand("select service_person.staff_id,service_person.id,team_id,service_person.`name`,avatar,gender,supplier.id as supplier_id from service_person left join supplier on service_person.staff_id=supplier.staff_id where supplier.account_id=".$_SESSION['account_id']." and service_type=".$type);
