...
class CaseResources extends InitActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('CR_Type',$this->CI_Place,true);
		$criteria->compare('CR_Sort',$this->CI_Pic,true);
		$criteria->compare('CR_Name',$this->CI_Time,true);
		$criteria->compare('CR_CreateTime',$this->CI_CreateTime,true);
		$criteria->compare('CR_Path',$this->CI_Sort,true);
