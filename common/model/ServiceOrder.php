 ...
 */
class ServiceOrder extends InitActiveRecord
{
	/**
	...
	public function search()
	{
		...
		$criteria->compare('service_team_id',$this->service_team_id);
		$criteria->compare('service_person_id',$this->service_person_id);
		$criteria->compare('order_id',$this->order_id,true);
		$criteria->compare('order_name',$this->order_name,true);
		$criteria->compare('linkman_name',$this->linkman_name);
		$criteria->compare('linkman_phone',$this->linkman_phone,true);
