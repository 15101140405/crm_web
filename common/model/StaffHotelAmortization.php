 ...
 */
class StaffHotelAmortization extends InitActiveRecord
{
	/**
	...
	{
		return 'staff_hotel_amortization';
	}
	...
	/*public function rules()
	{
		...
		return array(
			array('id, account_id, name, department_id, update_time', 'required'),
			array('id, account_id, name, department_id, update_time', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->compare('account_period',$this->account_period);
