...
class Order extends InitActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, account_id, planner_id, designer_id, staff_hotel_id, order_name, order_type, order_date, order_time, order_status, update_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('feast_deposit',$this->feast_deposit,true);
		$criteria->compare('medium_term',$this->medium_term,true);
